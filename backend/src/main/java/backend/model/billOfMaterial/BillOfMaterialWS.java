...
/**
 * A lean version of a BillOfMaterial that is used by the WebService to transfer object data.
 * The main difference to the regular BillOfMaterial is that IDs are used instead of object references.
 * 
 * @author Michael
 */
public class BillOfMaterialWS {
	 ...
	 */
	public void setItems(List<BillOfMaterialItemWS> items) {
		this.items = items;
	}
}
