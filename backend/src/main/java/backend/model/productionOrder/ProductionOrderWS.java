...
/**
 * A lean version of a production order that is used by the WebService to transfer object data.
 * The main difference to the regular ProductionOrder is that IDs are used instead of object references.
 * 
 * @author Michael
 */
public class ProductionOrderWS {
	 ...
	 */
	public void setItems(List<ProductionOrderItemWS> items) {
		this.items = items;
	}
}
