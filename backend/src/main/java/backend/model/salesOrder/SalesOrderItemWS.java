...
/**
 * A lean version of a sales order item that is used by the WebService to transfer object data. The main difference to
 * the regular SalesOrderItem is that IDs are used instead of object references.
 *
 * @author Michael
 */
