...
/**
 * A lean version of a purchase order item that is used by the WebService to transfer object data.
 * The main difference to the regular PurchaseOrderItem is that IDs are used instead of object references.
 * 
 * @author Michael
 */
