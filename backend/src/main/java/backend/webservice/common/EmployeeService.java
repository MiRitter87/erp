...
public class EmployeeService {
    ...
    public WebServiceResult getEmployees(final EmployeeHeadQueryParameter employeeHeadQuery) {
        ...
        try {
            ...
            getEmployeesResult.addMessage(new WebServiceMessage(WebServiceMessageType.E,
                    this.resources.getString("employee.getEmployeesError")));
    ...
    public WebServiceResult addEmployee(final Employee employee) {
        ...
        try {
            ...
            addEmployeeResult.addMessage(
                    new WebServiceMessage(WebServiceMessageType.S, this.resources.getString("employee.addSuccess")));
        } catch (Exception e) {
            addEmployeeResult.addMessage(
                    new WebServiceMessage(WebServiceMessageType.E, this.resources.getString("employee.addError")));
    ...
    public WebServiceResult updateEmployee(final Employee employee) {
        ...
        try {
            ...
            updateEmployeeResult.addMessage(
                    new WebServiceMessage(WebServiceMessageType.S, this.resources.getString("employee.updateSuccess")));
        } catch (ObjectUnchangedException objectUnchangedException) {
            updateEmployeeResult.addMessage(new WebServiceMessage(WebServiceMessageType.I,
                    this.resources.getString("employee.updateUnchanged")));
        } catch (Exception e) {
            updateEmployeeResult.addMessage(
                    new WebServiceMessage(WebServiceMessageType.E, this.resources.getString("employee.updateError")));
