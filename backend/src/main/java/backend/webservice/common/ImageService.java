...
public class ImageService {
    ...
    public WebServiceResult addImage(final ImageData image) {
        ...
        try {
            ...
            addImageResult.addMessage(
                    new WebServiceMessage(WebServiceMessageType.S, this.resources.getString("image.addSuccess")));
    ...
    public WebServiceResult updateImageMetaData(final ImageMetaData imageMetaData) {
        ...
        try {
            ...
            updateImageMetaDataResult.addMessage(new WebServiceMessage(WebServiceMessageType.S, MessageFormat
                    .format(this.resources.getString("image.metaData.updateSuccess"), imageMetaData.getId())));
        } catch (ObjectUnchangedException objectUnchangedException) {
            updateImageMetaDataResult.addMessage(new WebServiceMessage(WebServiceMessageType.I, MessageFormat
                    .format(this.resources.getString("image.metaData.updateUnchanged"), imageMetaData.getId())));
        } catch (Exception e) {
            updateImageMetaDataResult.addMessage(new WebServiceMessage(WebServiceMessageType.E, MessageFormat
                    .format(this.resources.getString("image.metaData.updateError"), imageMetaData.getId())));
