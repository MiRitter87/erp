...
public interface AccountDao {
	 ...
	 */
	void insertAccount(final Account account) throws Exception;
	 ...
	 */
	void deleteAccount(final Account account) throws Exception;
	 ...
	 * @throws Exception Account retrieval failed.
	 */
	Account getAccount(final Integer id) throws Exception;
	 ...
	 */
	void updateAccount(final Account account) throws ObjectUnchangedException, Exception;
}
