...
public interface DepartmentDao {
     ...
     */
    void insertDepartment(Department department) throws EntityExistsException, Exception;
     ...
     * @throws Exception Department retrieval failed.
     */
    Department getDepartmentByCode(String code) throws Exception;
     ...
     * @throws Exception Department retrieval failed.
     */
    Department getDepartmentByEmployeeId(Integer employeeId) throws Exception;
     ...
     */
    void updateDepartment(Department department) throws ObjectUnchangedException, Exception;
}
