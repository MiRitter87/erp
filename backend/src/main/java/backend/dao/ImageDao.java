...
public interface ImageDao {
     ...
     */
    void insertImage(ImageData image) throws Exception;
     ...
     */
    void updateImageMetaData(ImageMetaData imageMetaData) throws ObjectUnchangedException, Exception;
     ...
     */
    ImageData getImageData(Integer id) throws Exception;
     ...
     */
    ImageMetaData getImageMetaData(Integer id) throws Exception;
