...
public class DepartmentSoapServiceImplTest {
	...
	public void testGetDepartments() {
		...
		assertTrue(SoapTestTools.resultContainsErrorMessage(getDepartmentsResult) == false);
	...
	public void testGetDepartment() {
		...
		//Assure no error message exists
		assertTrue(SoapTestTools.resultContainsErrorMessage(getDepartmentResult) == false);
	...
	public void testAddValidDepartment() {
		...
		try {
			...
			//Assure no error message exists
			assertTrue(SoapTestTools.resultContainsErrorMessage(addDepartmentResult) == false);
	...
	public void testDeleteDepartment() {
		...
		try {
			...
			assertTrue(SoapTestTools.resultContainsErrorMessage(deleteDepartmentResult) == false);
	...
	public void testUpdateDepartment() {
		...
		try {
			...
			//Assure no error message exists
			assertTrue(SoapTestTools.resultContainsErrorMessage(updateDepartmentResult) == false);
