...
/**
 * <p>Java-Klasse f�r businessPartner complex type.
 *
 ...
 *         &lt;element name="types" type="{http://soap.webservice.backend/}businessPartnerType" maxOccurs="unbounded" minOccurs="0"/>
...
public class BusinessPartner {
    ...
    protected List<BusinessPartnerType> types;
     ...
     *
     */
    public List<BusinessPartnerType> getTypes() {
        if (types == null) {
            types = new ArrayList<BusinessPartnerType>();
        }
        return this.types;
    }
