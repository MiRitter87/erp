 ...
 *
 */
@WebServiceClient(name = "employeeService", targetNamespace = "http://soap.webservice.backend/", wsdlLocation = "http://127.0.0.1:8080/backend/services/soap/employeeService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICE_QNAME = new QName("http://soap.webservice.backend/", "employeeService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8080/backend/services/soap/employeeService?wsdl");
     ...
     */
    @WebEndpoint(name = "EmployeeSoapServiceImplPort")
    public EmployeeService getEmployeeSoapServiceImplPort() {
        return super.getPort(new QName("http://soap.webservice.backend/", "EmployeeSoapServiceImplPort"), EmployeeService.class);
    }
     ...
     */
    @WebEndpoint(name = "EmployeeSoapServiceImplPort")
    public EmployeeService getEmployeeSoapServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.webservice.backend/", "EmployeeSoapServiceImplPort"), EmployeeService.class, features);
    }
