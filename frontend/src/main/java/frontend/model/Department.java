...
public class Department {
     ...
     */
    public frontend.generated.ws.soap.department.Department getWebServiceDepartment()
            throws DatatypeConfigurationException {
        frontend.generated.ws.soap.department.Department wsDepartment =
                new frontend.generated.ws.soap.department.Department();

        wsDepartment.setCode(this.code);
        wsDepartment.setName(this.name);
        wsDepartment.setDescription(this.description);

        if (this.head != null) {
            wsDepartment.setHead(this.head.getWebServiceEmployeeForDepartmentService());
        }
