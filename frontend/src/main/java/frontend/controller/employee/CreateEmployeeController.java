...
public class CreateEmployeeController extends EmployeeController {
     ...
     */
    public void addEmployeeHandler(final ActionEvent e) {
        ...
        try {
            ...
            this.getEmployeeWebServiceDao().insertEmpoyee(newEmployee);
    ...
    private void displaySaveSuccessPopUp(final String fullName) {
        JOptionPane.showMessageDialog(this.createEmployeeView,
                MessageFormat.format(this.getResources().getString("gui.employee.information.createSuccess"), fullName),
     ...
     */
    public void setCreateEmployeeView(final CreateEmployeeView createEmployeeView) {
