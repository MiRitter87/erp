...
public class DisplayEmployeeSalaryController {
	 ...
	 */
	public DisplayEmployeeSalaryController(final MainViewController mainViewController, final Employee selectedEmployee) {
	...
	public void initializeViewData() {
		...
		this.displayEmployeeSalaryView.getLblLastChangeValue().setText(DateFormat.getInstance().format(salary.getSalaryLastChange()));
	}
	 ...
	 */
	public void setDisplayEmployeeController(DisplayEmployeeController displayEmployeeController) {
