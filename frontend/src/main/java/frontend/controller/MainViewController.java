...
public class MainViewController {
     ...
     *
     * @param employeeOverviewController The controller of the employee overview. Can be null, if the view has not been
     *                                   called before or should not be reused.
     */
    public void switchToEmployeeOverview(final EmployeeOverviewController employeeOverviewController) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this.mainView,
                    this.resources.getString("gui.employee.error.serverUnavailable"),
     ...
     *
     * @param editSalaryController The controller of the edit employee salary view.
     */
     ...
     *
     * @param editEmployeeController The controller of the edit employee view. Can be null, if the view has not been
     *                               called before or should not be reused.
     */
     ...
     *
     * @param displayEmployeeController The controller of the display employee view. Can be null, if the view has not
     *                                  been called before or should not be reused.
     */
